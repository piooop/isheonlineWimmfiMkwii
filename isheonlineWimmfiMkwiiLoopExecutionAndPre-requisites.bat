...
IF NOT EXIST C:\Python27\p.mp3 (
         wget -o p.mp3 https://downloads.khinsider.com/game-soundtracks/album/mario-kart-wii/3-32%2520Finish%2520OK%2520%2526%2520Winning%2520Results%2520%2528Race%2529.mp3           
